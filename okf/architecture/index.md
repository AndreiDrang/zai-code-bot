...
- [Storage authority model](storage-authority-model.md) — D1 is the source of truth; R2 is the PR-context blob tier; KV is a read-through cache; the Queue is transport.
