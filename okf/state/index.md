...
- [Job lifecycle and bounded leases](job-lifecycle.md) — The durable job state machine (`queued` → `running` → terminal) with 10-minute leases that prevent duplicate concurrent execution.
