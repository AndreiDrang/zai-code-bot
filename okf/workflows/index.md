...
- [LLM command execution](llm-command-execution.md) — The shared runner for review (agent-mode with Context Tools) and describe (direct), with guards, result persistence, and marker-idempotent comments.
