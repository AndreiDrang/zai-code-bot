...
├── lib/             # Code-scope tests (code-scope.test.js)
...
- Shared mock utilities live in `tests/helpers/mocks.js`; reuse rather than duplicating inline.
...
- Duplicating large fixtures inline when reusable fixtures already exist in `tests/fixtures/`.
