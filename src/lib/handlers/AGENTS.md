...
Applies to: `src/lib/handlers/` and descendants.

Inherits repository-wide guidance from `../../../AGENTS.md` and services-layer guidance from `../AGENTS.md`.

This file defines only local deltas for the command-handler subtree.
