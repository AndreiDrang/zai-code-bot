...
Inherits repository-wide guidance from `AGENTS.md` and service-layer guidance from `src/lib/AGENTS.md`.

This file defines only local differences for the handler layer.
